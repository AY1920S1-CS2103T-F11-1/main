...
To provide additional functionalities to the `leaderboard` and `getTop k` commands, there are few extensions that can be added to these two commands to allow you to customize them to your needs. These extensions and how to use them are listed below.
