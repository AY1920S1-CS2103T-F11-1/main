...
+
.  Type the command in the command box and press the enter key to execute it. +
e.g. typing *`help`* and pressing the enter key will open the help window.
...
* Type your commands in the textbox displayed on the Alfred UI. After you are done typing the command, press enter key on your keyboard to execute the command.
...
.Assign Mentor Command Example 1
image::AssignCommandExample1.png[height="200", width="500"]
...
.Assign Participant Command Example 2
image::AssignCommandExample2.png[height="200", width="500"]
//end::assign[]
...
.Remove Mentor Command Example 1
image::RemoveCommandExample1.png[height="200", width="500"]
...
.Remove Participant Command Example 1
image::RemoveCommandExample2.png[height="200", width="500"]
//end::remove[]
...
2.	Press the up arrow or down arrow arrow keys to navigate up and down the popup box.
...
4.	Press left arrow] or right arrow keys to navigate the cursor and fill in the respective fields. Press the enter key to execute the command.
