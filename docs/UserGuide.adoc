...
* Note that for the Specialisation and Subject fields, only the following values/categories are valid:
- Environmental
- Social
- Health
- Education
...
* Mentors also have a field called "Specialisation", which refers to the field of work they specialise in. The Specialisation must be chosen from the predetermined list of specialisations, as described in <<Adding an Entity: `add {participant/mentor/team}`>>.
****
...
* Teams also have a field called "Subject", which refers the area the team's project focuses on, and must be chosen from the predetermined list of subjects described in <<Adding an Entity: `add {participant/mentor/team}`>>.
****
