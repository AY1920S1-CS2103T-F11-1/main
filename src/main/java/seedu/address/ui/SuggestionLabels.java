...
public enum SuggestionLabels {
    ...
    NAME_PREFIX(new Text("n/")),
    PHONE_PREFIX(new Text("p/")),
    EMAIL_PREFIX(new Text("e/")),
    ORGANIZATION_PREFIX(new Text("o/")),
    SPECIALISATION_PREFIX(new Text("s/ ")),
    PROJECT_NAME_PREFIX(new Text("pn/ ")),
    SUBJECT_PREFIX(new Text("s/ ")),
    LOCATION_PREFIX(new Text("l/ ")),
    FILEPATH_PREFIX(new Text("fp/ ")),

    //Constants (that are used are guides)
    NAME(new Text("NAME ")),
    PHONE(new Text("PHONE_NUMBER ")),
    EMAIL(new Text("EMAIL_ADDRESS ")),
    TEAM_ID(new Text("TEAM_ID ")),
    PARTICIPANT_ID(new Text("PARTICIPANT_ID ")),
    MENTOR_ID(new Text("MENTOR_ID ")),
    NUMBER(new Text("NUMBER ")),
    POINTS(new Text("POINTS ")),
    NEW_POINTS(new Text("NEW_POINTS ")),
    CSV_PATH(new Text("PATH_TO_CSV_FILE ")),
    PARAMETERS(new Text("[PARAMETERS] ")),
    ...
    TABLE(new Text("TABLE_NUMBER ")),
    FILE_PATH(new Text("PATH_TO_CSV_FILE ")),
    ENTITY(new Text("[{team/mentor/participant}] "));
