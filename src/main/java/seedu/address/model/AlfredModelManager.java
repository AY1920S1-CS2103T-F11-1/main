...
/**
 * Represents the in-memory alfredModel of the address book data.
 */
public class AlfredModelManager implements AlfredModel {
    private static final Logger logger = LogsCenter.getLogger(AlfredModelManager.class);
    ...
    /**
     * Initializes a AlfredModelManager with the given addressBook and userPrefs.
     */
    private AlfredModelManager(ReadOnlyAlfred initialData, ReadOnlyUserPrefs userPrefs) throws AlfredException {
        super();
    ...
    /**
     * Returns a {@code AlfredModelManager} with the data from {@code storage}'s address
     ...
     */
    public static AlfredModel initModelManager(AlfredStorage storage, ReadOnlyUserPrefs userPrefs) throws AlfredException {
        ReadOnlyAlfred initialData = new Alfred(storage, userPrefs);

        return new AlfredModelManager(initialData, userPrefs);
    }
     ...
     */
    // We have two methods to initialize alfredModel manager, which one do you want to
    // use?
    /*
     ...
     * 
     * // Optional TODO: reimplement this alfredLogic here. //
    ...
    /**
     * Returns the participant list located in the AlfredModel Manager.
     *
    ...
    /**
     * Returns the team list located in the AlfredModel Manager.
     *
     * @return ReadableEntityList
     */
    ...
    /**
     * Returns the mentor list located in the AlfredModel Manager.
     *
     * @return ReadableEntityList
     */
    ...
    public void updateParticipant(Id id, Participant participant) {
        try {
            this.alfred.updateParticipant(id, participant);
    ...
    public Team getTeamByMentorId(Id mentorId) throws AlfredException {
        return this.alfred.getTeamByMentorId(mentorId);
    }
    ...
    public Team deleteTeam(Id id) throws AlfredException {
        return this.alfred.deleteTeam(id);
    }
    ...
    public Mentor getMentor(Id id) throws AlfredException {
       return this.alfred.getMentor(id);
    }
    ...
    public Mentor deleteMentor(Id id) throws AlfredException {
        return this.alfred.deleteMentor(id);
    }
